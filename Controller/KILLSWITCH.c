/*Danfoss PLUS+1 GUIDE Software: [ProjectToC] Version: 2024.2.4*/
/*Type: Educational*/
/*Id: 31977*/
/*Sub ID: 0*/
...
/**/
#include "header.h"
_Plus1Ver_T _Plus1Ver={'2','0','2','4','.','2','.','4'};
_CMS_AppId_T _AppId1_T _UserIdConst1={'_','_','N','O','B','U','S','E','R','I','D','_','3','1','9','7','7','\0'};
_CMS_AppId_T _AppId1_T _AppIdConst1={'_','_','N','O','B','P','C','O','M','_','K','i','l','l','S','w','i','t','c','h','\0'};
